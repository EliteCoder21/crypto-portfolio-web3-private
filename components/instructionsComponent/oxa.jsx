import styles from "./oxa.module.css";
export default function OXA() {
    ...
    return (        
        <div>
            ...
            <link rel="mask-icon" href="./assets/img/favicon/safari-pinned-tab.svg" color="#42b1e3" />
            ...
            <div>
                ...
                <div className="menu_logo">
                    ...
                    <img className="headBar-logo" src="./assets/img/openexamainlogo.png" />
                    </div>
                </div>
                <div className="flex">
                    <div className="relative group">
                    <a className="launchApp-link" href="https://openexa.to" target="_blank">
                        <button className="transition shadow-md" style={{borderRadius: '500px'}}>
                        <div>Credit Swap</div>
                        </button>
                    </a>
                    </div>
                    <div className="relative group">
                    <a className="launchApp-link" href="https://openexa.io" target="_blank">
                        <button className="transition shadow-md" style={{borderRadius: '500px'}}>
                ...
                <nav className="navbar navbar-expand navbar-light">
                    ...
                    <div className="navbar-collapse collapse" id="navbar-nav">
                        ...
                        <a className href="index.html" style={{marginLeft: '5px'}}><li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
                                <span className="material-icons md-20">dashboard</span>
                                </div>
                                <div className="text">
                                <span className="text1">Dashboard</span><span className="text2" />
                                </div>
                            </button></li></a><a className href="assets.html" style={{marginLeft: '5px'}}>
                            <li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
                                <span className="material-icons md-20">account_balance_wallet</span>
                                </div>
                                <div className="text">
                                <span className="text1">Assets</span><span className="text2" />
                                </div>
                            </button>
                            </li>
                        </a><a className href="aut.html" style={{marginLeft: '5px'}}><li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
                                <span className="material-icons md-20">monetization_on</span>
                                </div>
                                <div className="text">
                                <span className="text1">AUT</span><span className="text2" />
                                </div>
                            </button></li></a><a className="active" href="oxa.html" style={{marginLeft: '5px'}}><li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
                                <span className="material-icons md-20">token</span>
                                </div>
                                <div className="text">
                                <span className="text1">OXA</span><span className="text2" />
                                </div>
                            </button></li></a><a className href="holdings.html" style={{marginLeft: '5px'}}><li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
                                <span className="material-icons md-20">data_thresholding</span>
                                </div>
                                <div className="text">
                                <span className="text1">Digital Holdings</span><span className="text2" />
                                </div>
                            </button></li></a><a className href="market.html" style={{marginLeft: '5px'}}><li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
                                <span className="material-icons md-20">storefront</span>
                                </div>
                                <div className="text">
                                <span className="text1">Market</span><span className="text2" />
                                </div>
                            </button></li></a><a className href="activity.html" style={{marginLeft: '5px'}}><li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
                                <span className="material-icons md-20">swap_horiz</span>
                                </div>
                                <div className="text">
                                <span className="text1">Activity</span><span className="text2" />
                                </div>
                            </button></li></a>
                        </div>
                    </div>
            ...
            <div className="login-wrapper" id="login-wrapper">
                ...
                <span style={{width: '100%', display: 'flex', justifyContent: 'center'}}>
                    <img src="./assets/img/openexamainlogo.png" style={{width: '150px', height: 'auto', marginBottom: '20px'}} />
                </span>
            ...
            <div className="popup-wrapper" id="popup-wrapper">
                ...
                <button className="close-button">
                    <svg className="close-icon" width={1792} height={1792} viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="page dashboard" id="page-dashboard">
                ...
                <div className="dashboard-market-cap-card">
                    ...
                    <span className="subtitle" id="dashboard-market-cap">...</span>
                </div>
                <div className="dashboard-market-change-card">
                    <span className="title">24h Change</span>
                    <span className="subtitle" id="dashboard-market-change">...</span>
                </div>
                </div>
                ...
                <div className="headers-wrapper" data-list="dashboardMarket">
                    ...
                    <span className="header market-cap" data-item="marketCap">Market Cap</span>
                    <span className="header day" data-item="change">24h Change</span>
                </div>
                ...
                <div className="dashboard-holdings-card">
                    ...
                    <span className="subtitle" id="dashboard-holdings-value">...</span>
                </div>
                </div>
                <div className="dashboard-holdings-list-wrapper noselect">
                <div className="headers-wrapper" data-list="dashboardHoldings">
                    <span className="header coin" data-item="coin">Coin</span>
                    <span className="header amount" data-item="amount">Amount</span>
                    <span className="header value" data-item="value">Value</span>
                    <span className="header day" data-item="change">24h Change</span>
                </div>
                <div className="dashboard-holdings-list loading" id="dashboard-holdings-list">
                    <div className="coin-wrapper loading">
                    <span>Loading...</span>
                    </div>
                </div>
            ...
            <div className="page market" id="page-market">
                <div className="stats-wrapper noselect">
                <div className="stats-card market-cap">
                    <span className="stats-title">Market Cap</span>
                    <span className="stats-subtitle" id="global-market-cap">...</span>
                </div>
                <div className="stats-card volume">
                    <span className="stats-title">24h Volume</span>
                    <span className="stats-subtitle" id="global-volume">...</span>
                </div>
                <div className="stats-card dominance">
                    <span className="stats-title">BTC Dominance</span>
                    <span className="stats-subtitle" id="global-dominance">...</span>
                </div>
                </div>
            ...
            <div className="page holdings" id="page-holdings">
                ...
                <div className="headers-wrapper" data-list="holdings">
                    ...
                    <span className="header amount" data-item="amount">Amount</span>
                    <span className="header value" data-item="value">Value</span>
                    <span className="header day" data-item="change">24h Price Change</span>
                </div>
                ...
                <div className="holdings-value-card" id="holdings-value-card">
                    <span className="title">Total Value</span>
                    <span className="subtitle" id="holdings-total-value">...</span>
                </div>
            ...
            <div className="page activity" id="page-activity">
                ...
                <div className="headers-wrapper" data-list="activity">
                    <span className="header date" data-item="date">Date</span>
                    <span className="header symbol" data-item="coin">Coin</span>
                    <span className="header amount" data-item="amount">Amount</span>
                    <span className="header type" data-item="type">Type</span>
                    <span className="header notes" data-item="notes">Notes</span>
                </div>
            ...
            <div className="page autpage active" id="page-autpage">
                <h1 style={{lineHeight: '80px', fontWeight: 300, fontSize: '40px', color: 'white', margin: '0px', padding: '0px', textAlign: 'center'}}>
                OXA - OpenEXA Stable Credit Tokens
                </h1>
                <div style={{width: '80%', margin: 'auto'}} className="transactionTable">
                <div className="space-y-4 bg-white p-8 shadow-2xl" style={{backgroundColor: 'rgba(32, 34, 50, 0.5)', borderRadius: '20px'}}>
                    ...
                    <div className="mt-6 flex flex-col">
                        ...
                        <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    <th scope="col" className="px-4 py-3.5 text-left text-sm font-normal text-gray-500 rtl:text-right dark:text-gray-400">
                                    <button className="flex items-center gap-x-3 focus:outline-none">
                                        <span>Timestamp</span><svg className="h-3" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <th scope="col" className="px-12 py-3.5 text-left text-sm font-normal text-gray-500 rtl:text-right dark:text-gray-400">
                                    Block Number
                                    </th>
                                    <th scope="col" className="px-4 py-3.5 text-left text-sm font-normal text-gray-500 rtl:text-right dark:text-gray-400">
                                    Address
                                ...
                                <tbody className="divide-y divide-gray-200 bg-white dark:divide-gray-700" style={{backgroundColor: 'rgb(30, 34, 45)'}}>
            ...
            <div className="page settings" id="page-settings">
                ...
                <div className="bottom">
                    ...
                    <div className="toggle">
                        <svg className="sun" width={1792} height={1792} viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className="moon" width={1792} height={1792} viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <textarea id="theme-css-input" placeholder="Custom CSS..." spellCheck="false" defaultValue={"\t\t\t--shadow-dark:0 6px 10px rgba(40,40,40,0.25);\n\t\t\t--font-family:\"Helvetica Neue\", \"Lucida Grande\", \"Arial\", \"Verdana\", \"Tahoma\", sans-serif;"} />
                    <div className="button-wrapper">
                    <button className="submit" id="theme-css-confirm">Apply CSS</button>
                ...
                <div className="bottom">
                    <input type="password" placeholder="Current Password..." id="input-current-password" />
                    <input type="password" placeholder="New Password..." id="input-new-password" />
                    <input type="password" placeholder="Repeat New Password..." id="input-repeat-password" />
                    ...
                    <button className="submit" id="logout-button">Logout</button>
                </div>
                </div>
                <div className="section noapi-hidden">
                <div className="top noselect">
                ...
                <div className="bottom settings-choices-wrapper" data-key="shareHoldings">
                    <button className="server-choice" data-value="disabled">Disabled</button>
                    <button className="server-choice" data-value="enabled">Enabled</button>
                    <input type="text" placeholder="Access PIN..." id="input-access-pin" />
                    <button className="submit" id="change-pin-button">Confirm PIN</button>
                    <input type="text" placeholder="Sharing URL" id="sharing-url" readOnly />
                    <button className="submit" id="copy-url-button">Copy URL</button>
                </div>
                </div>
                ...
                <div className="description noselect">
                    <span>Using Ethplorer, the current balance of the tokens in your ETH
                    ...
                    aren't listed on CoinGecko would not get added.</span>
                </div>
                <div className="bottom">
                    <input type="text" placeholder="ETH Address..." id="input-eth-address" />
                    <div className="settings-choices-wrapper" data-key="importTokens">
                    <button className="choice" data-value="add">Add</button>
                    <button className="choice" data-value="replace">Replace</button>
                    </div>
                    <button className="submit" id="import-tokens-button">Import</button>
                </div>
                </div>
                ...
                <div className="description noselect">
                    <span>This progress bar displays how much storage space is left to store
                ...
                <div className="bottom">
                    ...
                    <button className="submit" id="noapi-clear-button">Clear Data</button>
                    <button className="submit" id="noapi-logout-button">Logout</button>
                </div>
                </div>
                <div className="section">
                <div className="top noselect">
                ...
                <div className="bottom settings-choices-wrapper" data-key="defaultPage">
                    <button className="choice" data-value="dashboard">Dashboard</button>
                    <button className="choice" data-value="market">Market</button>
                    <button className="choice" data-value="holdings">Holdings</button>
                    <button className="choice" data-value="activity">Activity</button>
                    <button className="choice" data-value="autpage">AUT/OXA</button>
                    <button className="choice" data-value="settings">Settings</button>
                </div>
                </div>
                <div className="section">
                <div className="top noselect">
                ...
                <div className="bottom settings-choices-wrapper" data-key="coinBackdrop">
                    <button className="choice" data-value="disabled">Disabled</button>
                    <button className="choice" data-value="enabled">Enabled</button>
                </div>
                </div>
                <div className="section">
                <div className="top noselect">
                ...
                <div className="bottom settings-choices-wrapper" data-key="highlightPriceChange">
                    <button className="choice" data-value="disabled">Disabled</button>
                    <button className="choice" data-value="row">Row</button>
                    <button className="choice" data-value="text">Text</button>
                </div>
                </div>
                <div className="section">
                <div className="top noselect">
                ...
                <div className="bottom settings-choices-wrapper" data-key="dashboardWatchlist">
                    <button className="choice" data-value="disabled">Disabled</button>
                    <button className="choice" data-value="enabled">Enabled</button>
                </div>
                </div>
                ...
                <div className="bottom settings-choices-wrapper" data-key="sortOrderNotification">
                    <button className="choice" data-value="disabled">Disabled</button>
                    <button className="choice" data-value="enabled">Enabled</button>
                </div>
                </div>
                ...
                <div className="bottom settings-choices-wrapper" data-key="additionalDashboardColumns">
                    <button className="choice" data-value="disabled">Disabled</button>
                    <button className="choice" data-value="enabled">Enabled</button>
                </div>
                </div>
                ...
                <div className="bottom settings-choices-wrapper" data-key="currency">
                    <button className="choice" data-value="usd">USD</button>
                    <button className="choice" data-value="gbp">GBP</button>
                    <button className="choice" data-value="eur">EUR</button>
                    <button className="choice" data-value="chf">CHF</button>
                    <button className="choice" data-value="aud">AUD</button>
                    <button className="choice" data-value="jpy">JPY</button>
                    <button className="choice" data-value="cad">CAD</button>
                </div>
                </div>
                <div className="section">
                <div className="top noselect">
                ...
                <div className="bottom settings-choices-wrapper" data-key="transactionsAffectHoldings">
                    <button className="choice" data-value="disabled">Disabled</button>
                    <button className="choice" data-value="mixed">Mixed</button>
                    <button className="choice" data-value="override">Override</button>
                </div>
                </div>
                <div className="section">
                <div className="top noselect">
                ...
                <div className="bottom settings-choices-wrapper" data-key="showTransactionsOnCharts">
                    <button className="choice" data-value="disabled">Disabled</button>
                    <button className="choice" data-value="enabled">Enabled</button>
                </div>
                </div>
