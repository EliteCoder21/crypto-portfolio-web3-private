    ...
    return (
        <div>
            ...
            <div>
                ...
                <nav className="navbar navbar-expand navbar-light">
                    ...
                    <div className="navbar-collapse collapse" id="navbar-nav">
                        ...
                        </a><a className href="assets.html" style={{marginLeft: '5px'}}>
                            <li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
                        ...
                        </a><a className="active" href="activity.html" style={{marginLeft: '5px'}}>
                            <li className="texticon">
                            <button type="button" className="buttonclass">
                                <div className="icon">
            ...
            <div className="page activity active" id="page-activity">
                ...
                Activity</h1>
                <div className="activity-card-wrapper noselect" style={{marginBottom: '20px'}}>
